...
fun strToint str = case Int.fromString str of
        SOME x => x
    |   NONE => 0
...
fun yyAction43 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm; (Tokens.INT(strToint yytext,yypos,yypos+size yytext))
      end
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ38(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ38(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
                else if inp < #"0"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction44(strm, yyNO_MATCH)
                      else yyQ38(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ38(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"e"
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ41(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp < #"l"
              then if inp <= #"`"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ38(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ39(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp < #"h"
              then if inp <= #"`"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ38(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
...
fun yyQ57 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ38(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ38(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ73 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction12(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ38(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ38(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ77 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction6(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ38(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ38(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ81 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction19(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ38(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ38(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ82(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
...
fun yyQ17 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ84(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ83(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
